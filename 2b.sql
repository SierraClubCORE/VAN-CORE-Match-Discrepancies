-- Record in VAN created many months after record created in SF (see column, modifieddays_apart)
...
SELECT a.id, a.firstname, a.lastname, a.mailingstreet, a.mailingcity, a.mailingstate, a.mailingpostalcode, a.phone, a.email, a.van_id_club__c, a.van_id_foundation__c, a.van_id_voter_file_club__c, a.van_state__c, a.lastmodifieddate, a.count, a.key, b.statecode, b.vanid, b.committeename, b.createdbyname, b.datemodified, CASE WHEN (createdbyname = 'API (c3), SalesforceSierraClub' AND b.vanid <> a.van_id_foundation__c) OR (createdbyname = 'API (c4), SalesforceSierraClub' AND b.vanid <> a.van_id_club__c) THEN 1 ELSE 0 END AS vanid_mismatch, DATEDIFF ( day, lastmodifieddate, datemodified) AS modifieddays_apart
FROM sfstep2 a
LEFT JOIN vanstep2 b 
	ON a.id = b.salesforceid
WHERE b.datemodified IS NOT NULL
ORDER BY 23 DESC, 16 ASC;
